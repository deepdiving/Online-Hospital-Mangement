                    ...
                    <div class="col-lg-12">                        
                        <div class="Content" id="printJS-form">
                            ...
                            <table class="table table-bordered table-hover Content"  cellpadding="5" cellspacing="0">
                                ...
                                <tr class="text-right">
                                    <td class="wd25percent">{{ __('messages.sales_revenues')}} : </td>
                                    <td class="wd15percent">{{Pharma::amountFormatWithCurrency($data['sale_revenue'])}}</td>
                                </tr>
                                <tr class="text-right">
                                    <td class="wd25percent">{{ __('messages.getable_dues') }} : </td>
                                    <td class="wd15percent">{{Pharma::amountFormatWithCurrency($data['dues'])}}</td>
                                </tr>
                                <tr class="text-right">
                                ...
                                <tr style="border-top: 2px solid" class="text-right font-weight-bold">
                                    ...
                                    <td class="wd15percent">{{Pharma::amountFormatWithCurrency( ($tsales = $data['sale_revenue'] + $data['due_collection']) + $data['dues'])}}</td>
                                </tr>
                            </table>
                            <table class="table table-bordered table-hover Content"  cellpadding="5" cellspacing="0">
                                <tr>
                                ...
                                <tr class="text-right">
                                    <td class="wd25percent">{{ __('messages.manu_Pay_cash') }}: </td>
                                    <td class="wd15percent">{{Pharma::amountFormatWithCurrency($data['supplier_payment'])}}</td>
                                </tr>
                                ...
                                <tr style="border-top: 2px solid" class="text-right font-weight-bold">
                                    ...
                                    <td class="wd15percent">{{Pharma::amountFormatWithCurrency($costOfSold = $total_exp + $data['supplier_payment'])}}</td>
                                </tr>
                            </table>
                            <table class="table table-bordered table-hover Content"  cellpadding="5" cellspacing="0">
                                <tr>
