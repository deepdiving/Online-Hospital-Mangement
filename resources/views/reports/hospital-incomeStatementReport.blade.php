                    ...
                    <div class="col-lg-12">
                        <form action="" method="get" class="form-inline float-right search">
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn search-btn-reset" href="{{url('reports/diagnostic-today')}}"><i class="fa fa-refresh"></i></a>
                    ...
                    <div class="col-lg-12">                        
                        <div class="Content" id="printJS-form">
                            <div class="invoiceHead text-center">
                                <h2>Hospital - {{$siteInfo->site_name}}</h2>
                            ...
                            <table class="table table-bordered table-hover Content"  cellpadding="5" cellspacing="0">
                                ...
                                <tr class="text-right">
                                    <td class="wd25percent">Hospital Bill Revenue : </td>
                                    <td class="wd15percent">{{Pharma::amountFormatWithCurrency($data['admission_revenue'])}}</td>
                                </tr>
                                <tr class="text-right">
                                    <td class="wd25percent">Operation Bill Revenue : </td>
                                    <td class="wd15percent">{{Pharma::amountFormatWithCurrency($data['operation_revenue'])}}</td>
                                </tr>
                                <tr class="text-right">
                                    <td class="wd25percent">Emergency Bill Revenue : </td>
                                    <td class="wd15percent">{{Pharma::amountFormatWithCurrency($data['emergency_revenue'])}}</td>
                                </tr>
                                <tr class="text-right">
                                    <td class="wd25percent">Bed Service Revenue : </td>
                                    <td class="wd15percent">{{Pharma::amountFormatWithCurrency($data['bedservice'])}}</td>
                                </tr>
                                <tr class="text-right">
                                    <td class="wd25percent">{{ __('messages.getable_dues') }} : </td>
                                    <td class="wd15percent">{{Pharma::amountFormatWithCurrency($currentDue = $data['dues']-$data['due_collection'])}}</td>
                                </tr>
                                <tr class="text-right">
                                    <td class="wd25percent">{{ __('messages.due_collection') }} : </td>
                                    <td class="wd15percent">{{Pharma::amountFormatWithCurrency($data['due_collection'])}}</td>
                                </tr>
                                <tr class="text-right">
                                ...
                                <tr style="border-top: 2px solid" class="text-right font-weight-bold">
                                    ...
                                    <td class="wd15percent">{{Pharma::amountFormatWithCurrency( $tsales = ($data['admission_revenue'] + $data['bedservice'] + $data['operation_revenue'] + $data['emergency_revenue'] ) + $data['dues'])}}</td>
                                </tr>
                            </table>
                            <table class="table table-bordered table-hover Content"  cellpadding="5" cellspacing="0">
                                <tr>
                                ...
                                <tr style="border-top: 2px solid" class="text-right font-weight-bold">
                                    ...
                                    <td class="wd15percent">{{Pharma::amountFormatWithCurrency($costOfSold = $total_exp + $data['referral_payment'])}}</td>
                                </tr>
                            </table>
                            <table class="table table-bordered table-hover Content"  cellpadding="5" cellspacing="0">
                                <tr>
