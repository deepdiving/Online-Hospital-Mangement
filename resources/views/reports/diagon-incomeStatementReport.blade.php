                    ...
                    <div class="col-lg-12">                        
                        <div class="Content" id="printJS-form">
                            <div class="invoiceHead text-center">
                                <h2>Diagnostic - {{$siteInfo->site_name}}</h2>
                            ...
                            <table class="table table-bordered table-hover Content"  cellpadding="5" cellspacing="0">
                                ...
                                <tr class="text-right">
                                    ...
                                    <td class="wd15percent">{{Pharma::amountFormatWithCurrency($data['bill_revenue'])}}</td>
                                </tr>
                                <tr class="text-right">
                                    <td class="wd25percent">Appointment Revenue : </td>
                                    <td class="wd15percent">{{Pharma::amountFormatWithCurrency($data['appoint_revenue'])}}</td>
                                </tr>
                                <tr class="text-right">
                                    <td class="wd25percent">{{ __('messages.getable_dues') }} : </td>
                                    <td class="wd15percent">{{Pharma::amountFormatWithCurrency($getableDues = $data['dues']-$data['due_collection'])}}</td>
                                </tr>
                                <tr class="text-right">
                                ...
                                <tr style="border-top: 2px solid" class="text-right font-weight-bold">
                                    ...
                                    <td class="wd15percent">{{Pharma::amountFormatWithCurrency( $tsales =  ($data['bill_revenue'] + $data['due_collection']) + $getableDues + $data['appoint_revenue'])}}</td>
                                </tr>
                            </table>
                            <table class="table table-bordered table-hover Content"  cellpadding="5" cellspacing="0">
                                <tr>
