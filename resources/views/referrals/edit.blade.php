...
@component('layout.inc.breadcrumb')
    @slot('title')
      {{__('messages.update')}} {{trans_choice('messages.new_referral',10)}}
    @endslot
@endcomponent
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle">{{__('messages.update')}} {{trans_choice('messages.new_referral',10)}}</h6>
                    <hr class="hr-borderd">
                    <form class="form-material m-t-40 form" action="{{ url('/referral/'.$DiagonReferral->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="form-group row {{ $errors->has('name') ? ' has-danger' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" value="{{old('name',$DiagonReferral->name)}}" class="form-control" id="name"  required autocomplete="off">
                        ...
                        <div class="form-group row {{ $errors->has('referral_category_id') ? ' has-danger' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <select name="referral_category_id" class="form-control" id="referral_category_id" required autocomplete="off">
                                 ...
                                 <option value="{{ $row->id}}"@if($row->id==$DiagonReferral->referral_category_id) selected @endif>{{ $row->cat_name }}</option>
                                 @endforeach   
                                </select>
                        ...
                        <div class="form-group row {{ $errors->has('designation') ? ' has-danger' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="designation" value="{{old('designation',$DiagonReferral->designation)}}" class="form-control" id="designation"   autocomplete="off">
                        ...
                        <div class="form-group row {{ $errors->has('contact') ? ' has-danger' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="contact" value="{{old('contact',$DiagonReferral->contact)}}" class="form-control" id="contact"  required autocomplete="off">
                        ...
                        <div class="form-group row {{ $errors->has('email') ? ' has-danger' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="email" name="email" value="{{old('email',$DiagonReferral->email)}}" class="form-control" id="email"   autocomplete="off">
