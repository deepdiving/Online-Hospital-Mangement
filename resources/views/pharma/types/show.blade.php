                ...
                <div class="card-body">
                    ...
                    <form class="form-material m-t-40">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input disabled type="text" value="{{$type->type_name}}" class="form-control text-dark">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 text-right control-label col-form-label">{{ __('messages.description') }} :</label>
                            <div class="col-sm-10">
                                <textarea disabled class="form-control text-dark" rows="5">{{$type->description}}</textarea>
                            </div>
                        </div>                              
                        <div class="form-group m-b-0">
                            <a href="{{route('type.index')}}" class="btn bg-theme text-light waves-effect float-right waves-light m-t-10">{{ __('messages.back') }}</a>
                        </div>
                    </form>
                </div>
            </div>
