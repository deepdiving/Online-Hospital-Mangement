@extends('layout.app',['pageTitle' => __('Add Type')])
@section('content')
            ...
            <div class="card">
                ...
                <form class="form-material m-t-40 form" action="{{ route('product_type.store') }}" method="post">
                    ...
                    <div class="form-group row {{ $errors->has('name') ? ' has-danger' : '' }}">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="type_name" value="{{old('type_name')}}" class="form-control" id="name" placeholder="Type name" required autocomplete="off">
                    ...
                    <div class="form-group row {{ $errors->has('description') ? ' has-danger' : '' }}">
                        ...
                        <div class="col-sm-10">
                            <textarea name="description" class="form-control" rows="10" placeholder="Tell me about this type."></textarea>
