    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <hr class="hr-borderd">
                <form class="form-material m-t-40 form" action="{{ route('product_type.update',$product_type) }}" method="post">
                    @csrf
                    @method('put')
                    <div class="form-group row {{ $errors->has('name') ? ' has-danger' : '' }}">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="type_name" value="{{old('type_name',$product_type->type_name)}}" class="form-control" id="name" placeholder="Type name" required autocomplete="off">
                    ...
                    <div class="form-group row {{ $errors->has('description') ? ' has-danger' : '' }}">
                        ...
                        <div class="col-sm-10">
                            <textarea name="description" class="form-control" rows="10" placeholder="Tell me about this type.">{{$product_type->description}}</textarea>
