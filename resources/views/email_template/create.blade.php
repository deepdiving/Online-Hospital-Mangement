...
@include('elements.alert')
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">{{ trans_choice('messages.template',1) }}</h4>
                    <h6 class="card-subtitle">{{ __('messages.create_tamplate') }}</h6>
                    <hr>
                    <form class="form-material m-t-40 form" action="{{ route('emailtemplate.store') }}" method="post">
                        @csrf
                        <div class="form-group row {{ $errors->has('name') ? ' has-danger' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" value="{{old('name')}}" class="form-control" id="name" placeholder="Template name" required autocomplete="off">
                        ...
                        <div class="form-group row {{ $errors->has('slug') ? ' has-danger' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="slug" value="{{old('slug')}}" class="form-control" id="slug" placeholder="Template slug should be unique" required autocomplete="off">
                        ...
                        <div class="form-group row {{ $errors->has('subject') ? ' has-danger' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="subject" value="{{old('subject')}}" class="form-control" id="subject" placeholder="Template subject" required autocomplete="off">
                        ...
                        <div class="form-group row {{ $errors->has('content') ? ' has-danger' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <textarea name="content" id="mymce" class="form-control" rows="10">{{old('content','Your Mail Body...')}}</textarea>
                        ...
                        <div class="form-group row {{ $errors->has('description') ? ' has-danger' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="description" value="{{old('description')}}" class="form-control" id="description" placeholder="Tell me about this template (optional)" autocomplete="off">
                        ...
                        <div class="form-group row {{ $errors->has('from_name') ? ' has-danger' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="from_name" value="{{old('from_name')}}" class="form-control" id="from_name" placeholder="sending name  (optional)" autocomplete="off">
                        ...
                        <div class="form-group row {{ $errors->has('from_email') ? ' has-danger' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="email" name="from_email" value="{{old('from_email')}}" class="form-control" id="from_email" placeholder="sending email  (optional)" autocomplete="off">
                        ...
                        <div class="form-group row {{ $errors->has('cc_email') ? ' has-danger' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="email" name="cc_email" value="{{old('cc_email')}}" class="form-control" id="cc_email" placeholder="cc email (optional)" autocomplete="off">
