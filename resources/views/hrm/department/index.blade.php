...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="col-md-7 d-inline-block">
            <div class="card">
            <div class="card-body">
                <h4 class="card-title d-inline">Department </h4><br>
                            ...
                            <tbody>
                                ...
                                @foreach($department as $row)
                                 <tr>
                                     ...
                                     <a class="btn waves-effect waves-light btn-xs btn-info" href="{{ url('department/'.$row->id) }}"><i class="fa fa-eye"></i></a>    
                                     <a class="btn waves-effect waves-light text-light btn-xs btn-warning" href="{{ url('department/'.$row->id.'/edit') }}"><i class="fa fa-edit"></i></a>  
                                     
                                     <form action="{{  url('department/'.$row->id) }}" method="post" style="margin-top:-2px" id="deleteButton{{$row->id}}">
                                         @csrf
                                         @method('delete')
    ...
    <div class="col-md-5 float-right">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle">Create New Department</h6>                   
                    <form class="form-material m-t-40 form" action="{{ url('department/') }}" method="post">
                        @csrf
                        ...
                        <div class="form-group row {{ $errors->has('description') ? ' has-danger' : '' }}">                          
                            ...
                            <div class="col-sm-8 col-md-8">
                                <input type="text" name="description" value="{{old('description')}}" class="form-control" id="name" placeholder="Description" required autocomplete="off">
                                @include('elements.feedback',['field' => 'name'])
                            </div>
                        </div>  
