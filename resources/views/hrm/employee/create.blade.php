@extends('layout.app',['pageTitle' => __('Add Employee')])
@section('content')
...
<form class="form-material form" action="{{ route('employee.store') }}" method="post" enctype="multipart/form-data">
    @csrf
<div class="row"> 
    <div class="col-lg-6 col-md-6">
        <div class="card">
            <div class="card-body"> 
                    <h3 class="form-title text-themecolor"><span>Employee Information</span></h3> 
                    ...
                    <div class="row m-l-20">
                        <div class="form-group col-md-6 m-t-20">
                            <input type="text" name="name" value="{{old('name')}}" class="form-control" id="name" placeholder="Name (required)" required autocomplete="off">
                            @include('elements.feedback',['field' => 'designation'])
                        </div>
                        <div class="form-group col-md-6 m-t-20">
                            <input type="text" name="date_of_birth" value="{{old(date('Y-m-d'))}}" class="form-control datepickerDB" id="date_of_birth" placeholder="Date Of Birth (required)" required autocomplete="off">
                            @include('elements.feedback',['field' => 'date_of_birth'])
                        </div> 
                        <div class="form-group col-md-6 m-t-20">
                            <input type="number" name="phone_no" value="{{old('phone_no')}}" maxlength="11" minlength="11" class="form-control" id="phone_no" placeholder="Phone number"  required autocomplete="off">
                            @include('elements.feedback',['field' => 'phone_no'])
                        </div>
                        <div class="form-group col-md-6 m-t-20">
                            <input type="email" name="email" value="{{old('email')}}" class="form-control" id="email" placeholder="Email" required autocomplete="off">
                        ...
                        <div class="form-group col-md-6 m-t-20">
                            <input type="text" name="joining_date" value="{{old(date('Y-m-d'))}}" class="form-control datepickerDB" id="joining_date" placeholder="Joining Date" autocomplete="off">
                            @include('elements.feedback',['field' => 'joining_date'])
                        </div> 
                        <div class="form-group col-md-6 m-t-20">
                            <input type="text" name="address" value="{{old('address')}}" class="form-control" id="address" placeholder="Address (required)" required autocomplete="off">
                     ...
                     <div class="row m-t-20 m-l-20">
                        <div class="form-group col-md-6 m-t-20">
                            <input type="number" name="emergency_contact" value="{{old('emergency_contact')}}" maxlength="11" minlength="11" class="form-control" id="emergency_contact" placeholder="Emenrgency Contact" autocomplete="off">
                            @include('elements.feedback',['field' => 'phone_no'])
                        </div>
                        <div class="form-group col-md-6 m-t-20">
                            <input type="text" name="emergency_address" value="{{old('emergency_address')}}" class="form-control" id="emergency_address" placeholder="Emergency Address" autocomplete="off">
                            @include('elements.feedback',['field' => 'address'])
                        </div> 
                     </div>               
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group row m-t-20 ">
                    ...
                    <div class="col-sm-9">
                        <input type="number" name="basic_salary" value="{{old('basic_salary')}}"   class="form-control" id="basic_salary" placeholder="0.00" required autocomplete="off">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="number" readonly name="gross_salary" value="{{old('gross_salary')}}"   class="form-control" id="gross_salary" placeholder="0.00" required autocomplete="off">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        @php $i = 0 @endphp
                    @foreach($Addstr as $str)
                        <div class="form-group row">
                                <label for="gross_salary" class="col-sm-4 text-right control-label col-form-label"><b>{{$str->title}}</b><sup class="text-danger font-bold">*</sup> :</label>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4"> 
                                    <input type="number" readonly name="addamount[]"  class="form-control addition" id="addamount{{++$i}}" placeholder="0.00" required autocomplete="off"> 
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-sm-4"> 
                                    <input type="number" readonly name="deductamount[]"   class="form-control deduct" id="deductamount{{++$i}}" placeholder="0.00" required autocomplete="off">  
                                    <input type="hidden" name="salary_structure_id[]" value="{{$str->id}}">
                                </div>
                            </div>
                            @endforeach
...
<div class="row">
    <div class="col-lg-12 col-md-12"> 
        <div class="form-group m-b-0">
            <button type="submit" class="btn btn-lg btn-themecolor m-t-10">{{__('messages.save')}}</button>
        </div>  
    </div> 
</div>
</div>
