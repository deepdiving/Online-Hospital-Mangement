...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="col-md-7 d-inline-block">
            <div class="card">
            <div class="card-body">
                <h4 class="card-title d-inline">Medicine Name</h4><br>
                <div class="col-lg-12">
                    <div class="Content">
                            ...
                            <?php $i = 0;?>
                               @foreach($medicine as $row)
                                <tr>
                                    ...
                                    <a class="btn waves-effect waves-light btn-xs btn-info" href="{{ url('medicines/'.$row->id) }}"><i class="fa fa-eye"></i></a>
                                    <a class="btn waves-effect waves-light text-light btn-xs btn-warning" href="{{ url('medicines/'.$row->id.'/edit') }}"><i class="fa fa-edit"></i></a>
                                    <form action="{{  url('medicines/'.$row->id) }}" method="post" style="margin-top:-2px" id="deleteButton{{$row->id}}">
                                            @csrf
                                            @method('delete')
        ...
        <div class="col-md-5 float-right">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle">Create New Medicine </h6>
                    <form class="form-material m-t-40 form" action="{{ url('/medicines') }}" method="post">
                        @csrf
