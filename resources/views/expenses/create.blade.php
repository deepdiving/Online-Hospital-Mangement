    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <h6 class="card-subtitle">{{__('messages.create_new')}} {{__('messages.expense')}}</h6>
                <hr class="hr-borderd">
                <form class="form-material m-t-40 form" action="{{ route('expense.store') }}" method="post">
                    ...
                    <div class="form-group row {{ $errors->has('date') ? ' has-danger' : '' }}">
                        ...
                        <div class="col-sm-10">
                            {{-- <input type="text" name="end" value="{{date('d-m-Y',strtotime($data['end']))}}" class="form-control datepickers"> --}}
                            <input type="text" name="date" value="{{date('d-m-Y')}}" class="form-control datepickers" id="date" required autocomplete="off">
                    ...
                    <div class="form-group row {{ $errors->has('expense_category_id') ? ' has-danger' : '' }}">
                        ...
                        <div class="col-sm-10">
                            <select name="expense_category_id" class="form-control" id="expense_category_id">
                                <?php echo Pharma::getOptions($eCategories,'category_name',old('expense_category_id'));?>
                            </select>
                    ...
                    <div class="form-group row {{ $errors->has('description') ? ' has-danger' : '' }}">
                        ...
                        <div class="col-sm-10">
                            <textarea name="description" class="form-control" rows="10" required placeholder="Tell me about this Umit."></textarea>
                    ...
                    <div class="form-group m-b-0 float-right">
                        <button type="submit" class="btn bg-theme text-white">Submit</button>
                    </div>
                </form>
                </div>
            </div>
