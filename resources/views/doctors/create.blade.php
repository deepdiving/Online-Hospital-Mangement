@extends('layout.app',['pageTitle' => __('Add Doctor')])
@section('content')
...
<div class="row">
    ...
    <div class="col-lg-8 col-md-8" >
        <div class="card">
            <div class="card-body ">
                <form class="form-material form" action="{{ route('doctor.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row m-t-20">
                      ...
                      <div class="form-group col-md-6 m-t-20">
                            <textarea name="biography" class="form-control" rows="9" placeholder="{{__('messages.write_a_note')}}"></textarea>
                        </div>


                        <div class="form-group col-md-6 m-t-20">
                            <input type="text" name="full_name" id="full_name" class="form-control form-control-line" placeholder="Doctor name (required)" required autocomplete="off" value="{{old('full_name')}}">
                            @include('elements.feedback',['field' => 'full_name'])
                        </div>
                        <div class="form-group col-md-6 m-t-20">
                            <input type="text" name="designation" value="{{old('designation')}}" class="form-control  form-control-line" id="designation" placeholder="Designation (required)" required autocomplete="off">
                            @include('elements.feedback',['field' => 'designation'])
                        </div>
                        <div class="form-group col-md-6 m-t-20">
                            <input type="number" name="phone_no" value="{{old('phone_no')}}" maxlength="10" minlength="7" class="form-control  form-control-line" id="phone_no" placeholder="{{__('messages.telephone_number')}} "  autocomplete="off">
                            @include('elements.feedback',['field' => 'phone_no'])
                        </div>
                        <div class="form-group col-md-6 m-t-20">
                            <input type="number" name="mobile_no" value="{{old('mobile_no')}}" maxlength="11" minlength="11" class="form-control  form-control-line" id="mobile_no" placeholder="Mobile Number (required)" required autocomplete="off">
