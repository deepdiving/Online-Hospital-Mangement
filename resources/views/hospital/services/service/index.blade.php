@extends('layout.app',['pageTitle' => 'Services'])
@section('content')
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="col-md-7 d-inline-block">
            <div class="card">
            <div class="card-body">
                <h4 class="card-title d-inline">Services</h4><br>
                            ...
                            <tbody>
                               ...
                               @foreach($services as $service)
                                <tr>
                                    ...
                                    <a class="btn waves-effect waves-light btn-xs btn-info" href="{{ url('hospital/services/service/'.$service->slug) }}"><i class="fa fa-eye"></i></a>
                                       
                                        <a class="btn waves-effect waves-light text-light btn-xs btn-warning" href="{{ url('hospital/services/service/'.$service->slug.'/edit') }}"><i class="fa fa-edit"></i></a>
                                       
                                        <form action="{{ url('hospital/services/service/'.$service->slug) }}" method="post" style="margin-top:-2px" id="deleteButton{{$service->id}}">
                                            @csrf
                                            @method('delete')
