...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="col-md-7 d-inline-block">
            <div class="card">
            <div class="card-body">
                <h4 class="card-title d-inline">Operation Type</h4><br>
                            ...
                            <tbody>
                               ...
                               @foreach($operation as $row)
                                <tr>
                                    ...
                                    <a class="btn waves-effect waves-light btn-xs btn-info" href="{{ url('hospital/operation/type/'.$row->id) }}"><i class="fa fa-eye"></i></a>    

                                    <a class="btn waves-effect waves-light text-light btn-xs btn-warning" href="{{ url('hospital/operation/type/'.$row->id.'/edit') }}"><i class="fa fa-edit"></i></a>  

                                    <form action="{{  url('hospital/operation/type/'.$row->id) }}" method="post" style="margin-top:-2px" id="deleteButton{{$row->id}}">
                                            @csrf
                                            @method('delete')
