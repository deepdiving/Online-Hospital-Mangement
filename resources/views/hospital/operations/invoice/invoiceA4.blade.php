...
@extends('layout.app',['pageTitle' => 'Operation'])
@section('content')
                        ...
                        <div class="row">
                            <div class="col-md-6 b-r">
                                ...
                                <p class="float-right mt-1">
                                    ...
                                    {{Pharma::dateFormat($invoicePrint->date) }} {{ date('g:i a', strtotime($invoicePrint->time)) }}<br>
                                    ...
                                    <tbody class="borderhade">
                                       <?php $sl = 0; ?>  
                                            <tr class="">
                                                ...
                                                <td>{{ $invoicePrint->operation_service_name }}. ({{Pharma::dateFormat ($invoicePrint->date) }})</td>
                                                <td class="text-right"> {{ Pharma::amountFormatWithCurrency($invoicePrint->operation_service_price) }}</td>
                                            </tr> 
                                    </tbody>
                                </table>
