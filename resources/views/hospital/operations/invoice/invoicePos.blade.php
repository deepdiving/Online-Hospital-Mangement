            ...
            <div class="card-body">
                ...
                <div id="printArea">
                    ...
                    <p class="float-right">
                         ...
                         {{Pharma::dateFormat($invoicePrint->date) }} {{ date('g:i a', strtotime($invoicePrint->time)) }}
                    </p>    
                        ...
                        <tbody class="borderhade">
                            <?php $sl = 0; ?> 
                                <tr class="">
                                    ...
                                    <td>{{ $invoicePrint->operation_service_name }}.
                                       <p class="font"> {{Pharma::dateFormat ($invoicePrint->date) }}</p>
                                    </td>
