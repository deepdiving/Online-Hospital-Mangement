...
<form action="{{ url('hospital/admission') }}" method="post" class="form-material form" id="deleteButton1">
    @csrf
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div id="user_area" class="">
                        <div class="row"> 
                            ...
                            <div class="form-group col-md-4">
                                <input type="number" name="age" maxlength="2" value="{{old('age')}}" class="form-control  form-control-line" id="age" placeholder="{{__('messages.age')}} "  autocomplete="off">
                            </div>
                            <div class="form-group col-md-8">
                            ...
                            <div class="form-group col-md-12">
                                <input type="text" name="address" value="{{old('address')}}" class="form-control  form-control-line" id="address" placeholder="{{__('messages.address')}} "  autocomplete="off"> @include('elements.feedback',['field' => 'address'])
                            </div>
                            <div class="form-group col-md-7">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            <select name="bed_id" class="form-control js-example-basic-single" id="bed_id" required autocomplete="off">
                                <option value="" selected disabled>Select Bed</option>
                                @foreach ($beds as $row)
                                    <option value="{{$row->id}}">{{ $row->bed_no }} ({{ $row->price }})/day</option>
                                 @endforeach   
                            </select>
                                ...
                                <div class="invoice-box">
                                    <table cellpadding="0" cellspacing="0" class="table-bordered">
                                        ...
                                        <tr class="font-weight-bold">
                                            ...
                                            <td class="text-right" id="cartTotal">{{number_format($serviceAdmission->price,2)}}</td>
                                            <td></td>
                                        </tr>
                                    </table>
                                </div>
                    ...
                    <div class="card card-outline-inverse">
                        ...
                        <div class="card-body"> 
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="sub_total" value="{{number_format($serviceAdmission->price,2)}}" readonly tabindex="-1" class="form-control" id="sub_total" placeholder="0.00" required autocomplete="off">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="grandTotal" value="{{number_format($serviceAdmission->price,2)}}" readonly tabindex="-1" class="form-control" id="grandTotal" placeholder="0.00" required autocomplete="off">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row" id="change-field"  style="display:none">
                                <label for="change" class="col-sm-3 text-right control-label col-form-label">Advance<sup class="text-danger font-bold">*</sup> :</label>
                                <div class="col-sm-9">
                            ...
                            <button type="submit" class="btn btn-md bg-theme text-white float-right" onclick="sweetalertDelete(1)" disabled id="finalCheckOUT"><i class="fa fa-paper-plane-o"></i> &nbsp;Admit</button>
                        </div>
                    </div>
...
@push('js')
@include('elements.hms-admission'); 
