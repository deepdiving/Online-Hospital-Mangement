            ...
            <div class="card-body">
                <div class="d-flex flex-row">
                    ...
                    <div class="m-l-10 align-self-center">
                        ...
                        <h5 class="text-muted m-b-0">Total Bill Amount</h5></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                <div class="d-flex flex-row">
                    ...
                    <div class="m-l-10 align-self-center">
                        ...
                        <h5 class="text-muted m-b-0">Total Due</h5></div>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title text-themecolor">Bill History</h4>
                <h6 class="card-subtitle">Last 30 Days Bill History</h6>
...
<div class="row">
    ...
    <div class="col-lg-8 col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title text-themecolor">Receive</h4>
