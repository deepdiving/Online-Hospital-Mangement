...
<body class="fix-header card-no-border">
    ...
    <section id="wrapper" class="error-page">
        <div class="error-box" style="background: url({{asset('material')}}/assets/images/background/error-bg.jpg) no-repeat center center #fff;">
            <div class="error-body text-center">
                <h1>404</h1>
                <h3 class="text-uppercase">Page Not Found !</h3>
                <p class="text-muted m-t-30 m-b-30">YOU SEEM TO BE TRYING TO FIND HIS WAY HOME</p>
                <a href="{{asset('material')}}/index.html" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Back to home</a> </div>
